          ...
          <Container className="nav flex-column pt-2">
            <Nav className="nav nav-pills flex-column mt-4" >
              <Nav.Item className="nav-item custom-nav-item">
                <NavLink className="nav-link d-flex align-items-center" to="/" onClick={handleClose}>
              ...
              <Nav.Item className="nav-item custom-nav-item">
                <NavLink className="nav-link d-flex align-items-center" to="/about" onClick={handleClose}>
